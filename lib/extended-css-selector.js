...
var ExtendedSelector = (function () { // jshint ignore:line
    ...
    Sizzle.selectors.pseudos["contains"] = Sizzle.selectors.pseudos["has-text"] = Sizzle.selectors.pseudos["-abp-contains"] = undefined;
    ...
    Sizzle.selectors.setFilters["contains"] = function (elements, argument, not) {
        var text = argument.replace(/\\([\\()[\]"])/g, '$1');
    ...
    Sizzle.selectors.pseudos["-abp-has"] = Sizzle.selectors.pseudos["has"] = undefined;

    var compiled = {};
    Sizzle.selectors.setFilters["has"] = function (elements, argument, not) {
        var selector = argument;
        if (typeof selector === "string" && !compiled[selector]) {
            Sizzle.compile(selector);
            compiled[selector] = true;
        }
        ...
        while (iElements--) {
            var element = elements[iElements];
            if (Sizzle(selector, element).length > 0) {
                result.push(element);
            }
        }
