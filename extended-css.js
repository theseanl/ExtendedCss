/*! extended-css - v1.0.9 - 2018-02-08
...
utils.AsyncWrapper = function () {
    ...
    AsyncWrapper.prototype.runAsap = utils.MutationObserver ? function () {
        ...
        // MO handles coalescing automatically, for setTimeout we have to 
        // do it by our own.
        if (this.hasPendingCallback()) {
            return;
        }
        this._runAsap = true;
        setTimeout(this.wrappedAsapCallback);
    };
    if (!utils.MutationObserver) {
        AsyncWrapper.prototype.wrappedAsapCallback = function () {
            if (this._runAsap) {
...
var StyleObserver = function () {
    ...
    var getSelector = function (filter) {
        ...
        getSelectorCache[filter] = selectorText;
...
var ExtendedSelector = function () {
    ...
    var propertiesReverseSearch = function (sel, propertyFilter, node, results) {
        ...
        var selector = StyleObserver.getSelector(propertyFilter);
        if (selector.length === 0) {
            return;
        }
        var nodes = node.querySelectorAll(selector);
